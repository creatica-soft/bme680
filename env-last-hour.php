...
$def_t = "DEF:t=/var/rrd/env.rrd:temperature:LAST";
$def_h = "DEF:h=/var/rrd/env.rrd:humidity:LAST";
$def_p = "DEF:p=/var/rrd/env.rrd:pressure:LAST";
$def_a = "DEF:a=/var/rrd/env.rrd:iaq:LAST";
$def_as = "DEF:as=/var/rrd/env.rrd:iaqs:LAST";
$def_ap = "DEF:ap=/var/rrd/env.rrd:iaqp:LAST";
$def_co = "DEF:ap=/var/rrd/env.rrd:co2eq:LAST";
$def_bvoc = "DEF:ap=/var/rrd/env.rrd:bvoc:LAST";
